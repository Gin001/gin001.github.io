$(function(){
    ...
    var phoneElement = $('#mmPhone');
    var nameElement = $('#mmName');
    var textElement = $('#mmText');

    var resultElement = document.getElementById('requestResult');
    ...
    function sendRequest (event) {
        ...
        xhr.open('POST', '/new_request', true);
